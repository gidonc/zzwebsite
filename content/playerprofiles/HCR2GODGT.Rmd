...
this_res_long <- readRDS(paste0(rprojroot::find_rstudio_root_file(), "/playerprofiles/res_long.RDS")) %>%
  filter(Players=="HCR2 GOD", team=="GT")
...
HCR2 GOD is currently a player in GT.  
...
Their best score was 5684 in Bill's Ok Adventure 1.

Their highest rank within the team was `r bestrank` `r best` 

Their scores relative to the rest of the team are shown in the figure and table below. In the figure, the red line shows the trajectory of HCR2 GOD's scores. The grey line shows the team median and the grey ribbon indicates the range from top five score to bottom five score.

![HCR2 GOD performance relative to each team](HCR2GODGT.jpg)
