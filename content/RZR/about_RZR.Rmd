...
all_matches %>%
  ...
  annotate(x=135, y=250, geom="text", label="Layoo starts tracking", vjust=1, angle=90) +
...
all_matches %>%
  ...
  annotate(x=170, y=200, geom="text", label="world rank 200", vjust=1) +
  geom_vline(xintercept=110) +
  annotate(x=110, y=750, geom="text", label="mergers", vjust=1, angle=90) +
