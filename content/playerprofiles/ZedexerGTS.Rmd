...
this_res_long <- readRDS(paste0(rprojroot::find_rstudio_root_file(), "/playerprofiles/res_long.RDS")) %>%
  filter(Players=="Zedexer", team=="GTS")
...
Zedexer is currently a player in GTS.  
...
Their best score was 33545 in Breathe In, Breathe Out 3.
...
![Zedexer performance relative to each team](ZedexerGTS.jpg)
