...
this_res_long <- readRDS(paste0(rprojroot::find_rstudio_root_file(), "/playerprofiles/res_long.RDS")) %>%
  filter(Players=="MOOSEYY", team=="GS")
...
MOOSEYY is currently a player in GS.

Their best score has been 22266 in Bigger And Better 1.

Their highest rank within the team was `r bestrank` `r best` 

The red line in the graph below shows the trajectory of MOOSEYY's scores. The grey line shows the team median and the grey ribbon indicates the range from top five score to bottom five score.

![MOOSEYY performance relative to each team](MOOSEYY.jpg)
