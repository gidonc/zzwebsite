...
this_res_long <- readRDS(paste0(rprojroot::find_rstudio_root_file(), "/playerprofiles/res_long.RDS")) %>%
  filter(Players=="Scuba Steve", team=="GTS")
...
Scuba Steve is currently a player in GTS.  
...
Their best score was 31442 in Timesplitting 3.
...
![Scuba Steve performance relative to each team](ScubaSteveGTS.jpg)
