...
this_res_long <- readRDS(paste0(rprojroot::find_rstudio_root_file(), "/playerprofiles/res_long.RDS")) %>%
  filter(Players=="markman", team=="GTS")
...
markman is currently a player in GTS.  
...
Their best score was 31628 in Timesplitting 3.
...
![markman performance relative to each team](markmanGTS.jpg)
