...
this_res_long <- readRDS(paste0(rprojroot::find_rstudio_root_file(), "/playerprofiles/res_long.RDS")) %>%
  filter(Players=="ade1962", team=="GT")
...
ade1962 is currently a player in GT.  
...
Their best score was 24660 in Bill's Ok Adventure 3.
...
![ade1962 performance relative to each team](ade1962GT.jpg)
