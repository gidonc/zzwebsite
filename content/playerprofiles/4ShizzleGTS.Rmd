...
this_res_long <- readRDS(paste0(rprojroot::find_rstudio_root_file(), "/playerprofiles/res_long.RDS")) %>%
  filter(Players=="4Shizzle", team=="GTS")
...
4Shizzle is currently a player in GTS.  
...
Their scores relative to the rest of the team are shown in the figure and table below. In the figure, the red line shows the trajectory of 4Shizzle's scores. The grey line shows the team median and the grey ribbon indicates the range from top five score to bottom five score.

![4Shizzle performance relative to each team](4ShizzleGTS.jpg)
