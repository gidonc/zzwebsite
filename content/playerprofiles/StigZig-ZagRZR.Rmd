...
this_res_long <- readRDS(paste0(rprojroot::find_rstudio_root_file(), "/playerprofiles/res_long.RDS")) %>%
  filter(Players=="Stig", team=="Zig-Zag RZR")
...
Stig is currently a player in Zig-Zag RZR.  
...
Their best score was 28781 in Breath In, Breath Out 3.

Their highest rank within the team was `r bestrank` `r best` 

Their scores relative to the rest of the team are shown in the figure and table below. In the figure, the red line shows the trajectory of Stig's scores. The grey line shows the team median and the grey ribbon indicates the range from top five score to bottom five score.

![Stig performance relative to each team](StigZig-ZagRZR.jpg)
