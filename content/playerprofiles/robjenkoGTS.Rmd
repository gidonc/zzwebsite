...
this_res_long <- readRDS(paste0(rprojroot::find_rstudio_root_file(), "/playerprofiles/res_long.RDS")) %>%
  filter(Players=="robjenko", team=="GTS")
...
robjenko is currently a player in GTS.  
...
Their best score was 32344 in Member Berries 1.
...
![robjenko performance relative to each team](robjenkoGTS.jpg)
