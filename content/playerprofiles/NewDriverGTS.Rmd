...
this_res_long <- readRDS(paste0(rprojroot::find_rstudio_root_file(), "/playerprofiles/res_long.RDS")) %>%
  filter(Players=="New Driver", team=="GTS")
...
New Driver is currently a player in GTS.  
...
Their best score was 19368 in Breathe In, Breathe Out 3.
...
![New Driver performance relative to each team](NewDriverGTS.jpg)
