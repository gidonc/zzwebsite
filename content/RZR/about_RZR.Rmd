...
RZR currently has `r current_cups` cups and is ranked `r current_rank` in the world. This was measured going into the match against `r last_opponent` (`r last_round`).
