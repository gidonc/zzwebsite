...
this_res_long <- readRDS(paste0(rprojroot::find_rstudio_root_file(), "/playerprofiles/res_long.RDS")) %>%
  filter(Players=="ExW|F$YT", team=="GT")
...
ExW|F$YT is currently a player in GT.  
...
Their best score was 16562 in Canyonball 4.

Their highest rank within the team was `r bestrank` `r best` 

Their scores relative to the rest of the team are shown in the figure and table below. In the figure, the red line shows the trajectory of ExW|F$YT's scores. The grey line shows the team median and the grey ribbon indicates the range from top five score to bottom five score.

![ExW|F$YT performance relative to each team](ExWFYTGT.jpg)
