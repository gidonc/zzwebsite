...
this_res_long <- readRDS(paste0(rprojroot::find_rstudio_root_file(), "/playerprofiles/res_long.RDS")) %>%
  filter(Players=="KAWASAKI H2R", team=="GTS")
...
KAWASAKI H2R is currently a player in GTS.  
...
Their best score was 20305 in Falling With Style 3.

Their highest rank within the team was `r bestrank` `r best` 

Their scores relative to the rest of the team are shown in the figure and table below. In the figure, the red line shows the trajectory of KAWASAKI H2R's scores. The grey line shows the team median and the grey ribbon indicates the range from top five score to bottom five score.

![KAWASAKI H2R performance relative to each team](KAWASAKIH2RGTS.jpg)


### KAWASAKI H2R's scores
