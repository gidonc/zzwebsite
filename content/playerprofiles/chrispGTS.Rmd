...
this_res_long <- readRDS(paste0(rprojroot::find_rstudio_root_file(), "/playerprofiles/res_long.RDS")) %>%
  filter(Players=="chris p", team=="GTS")
...
chris p is currently a player in GTS.  
...
Their best score was 32160 in Member Berries 1.
...
![chris p performance relative to each team](chrispGTS.jpg)
