...
this_res_long <- readRDS(paste0(rprojroot::find_rstudio_root_file(), "/playerprofiles/res_long.RDS")) %>%
  filter(Players=="4Shilzzle", team=="GTS")
...
4Shilzzle is currently a player in GTS.  
...
Their best score was 31107 in Suspension Check 2.
...
![4Shilzzle performance relative to each team](4ShilzzleGTS.jpg)
