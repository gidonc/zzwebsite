...
DanGT is currently a player in GT.  
...
Their best score was 26482 in Bigger And Better 2.

Their highest rank within the team was `r bestrank` `r best` 

Their scores relative to the rest of the team are shown in the figure and table below. In the figure, the red line shows the trajectory of DanGT's scores. The grey line shows the team median and the grey ribbon indicates the range from top five score to bottom five score.

![DanGT performance relative to each team](DanGTGT.jpg)
