...
this_res_long <- readRDS(paste0(rprojroot::find_rstudio_root_file(), "/playerprofiles/res_long.RDS")) %>%
  filter(Players=="DaveSmith85", team=="GTS")
...
DaveSmith85 is currently a player in GTS.  
...
Their best score was 28320 in Member Berries 1.
...
![DaveSmith85 performance relative to each team](DaveSmith85GTS.jpg)
