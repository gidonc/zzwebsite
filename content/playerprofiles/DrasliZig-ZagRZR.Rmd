...
this_res_long <- readRDS(paste0(rprojroot::find_rstudio_root_file(), "/playerprofiles/res_long.RDS")) %>%
  filter(Players=="Drasli", team=="Zig-Zag RZR")
...
Their best score was 34811 in Bill's Ok Adventure 4.
...
![Drasli performance relative to each team](DrasliZig-ZagRZR.jpg)
