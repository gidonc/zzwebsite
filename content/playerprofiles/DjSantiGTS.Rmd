...
this_res_long <- readRDS(paste0(rprojroot::find_rstudio_root_file(), "/playerprofiles/res_long.RDS")) %>%
  filter(Players=="DjSanti", team=="GTS")
...
DjSanti is currently a player in GTS.  
...
Their best score was 30161 in Timesplitting 3.
...
![DjSanti performance relative to each team](DjSantiGTS.jpg)
