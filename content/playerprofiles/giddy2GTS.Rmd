...
this_res_long <- readRDS(paste0(rprojroot::find_rstudio_root_file(), "/playerprofiles/res_long.RDS")) %>%
  filter(Players=="giddy2", team=="GTS")
...
giddy2 is currently a player in GTS.  
...
Their best score was 35669 in Suspension Check 3.
...
![giddy2 performance relative to each team](giddy2GTS.jpg)
