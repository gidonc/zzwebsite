...
Their best score has been 26482 in Bigger And Better 2.

Their highest rank within the team was `r bestrank` `r best` 

The red line in the graph below shows the trajectory of DanGT's scores. The grey line shows the team median and the grey ribbon indicates the range from top five score to bottom five score.
