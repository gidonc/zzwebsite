...
this_res_long <- readRDS(paste0(rprojroot::find_rstudio_root_file(), "/playerprofiles/res_long.RDS")) %>%
  filter(Players=="ninja", team=="Zig-Zag RZR")
...
ninja is currently a player in Zig-Zag RZR.  
...
Their best score was 27802 in High Gear Low Gear 3.
...
![ninja performance relative to each team](ninjaZig-ZagRZR.jpg)
