...
this_res_long <- readRDS(paste0(rprojroot::find_rstudio_root_file(), "/playerprofiles/res_long.RDS")) %>%
  filter(Players=="speedy34918", team=="Zig-Zag RZR")
...
speedy34918 is currently a player in Zig-Zag RZR.  
...
Their best score was 29641 in Grinding Gears 3.

Their highest rank within the team was `r bestrank` `r best` 

Their scores relative to the rest of the team are shown in the figure and table below. In the figure, the red line shows the trajectory of speedy34918's scores. The grey line shows the team median and the grey ribbon indicates the range from top five score to bottom five score.

![speedy34918 performance relative to each team](speedy34918Zig-ZagRZR.jpg)


### speedy34918's scores
