...
this_res_long <- readRDS(paste0(rprojroot::find_rstudio_root_file(), "/playerprofiles/res_long.RDS")) %>%
  filter(Players=="a22ude", team=="Zig-Zag RZR")
...
a22ude is currently a player in Zig-Zag RZR.  
...
Their best score was 16700 in Canyonball 2.

Their highest rank within the team was `r bestrank` `r best` 

Their scores relative to the rest of the team are shown in the figure and table below. In the figure, the red line shows the trajectory of a22ude's scores. The grey line shows the team median and the grey ribbon indicates the range from top five score to bottom five score.

![a22ude performance relative to each team](a22udeZig-ZagRZR.jpg)
