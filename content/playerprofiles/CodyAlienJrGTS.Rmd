...
this_res_long <- readRDS(paste0(rprojroot::find_rstudio_root_file(), "/playerprofiles/res_long.RDS")) %>%
  filter(Players=="CodyAlienJr", team=="GTS")
...
CodyAlienJr is currently a player in GTS.  
...
Their best score was 36734 in Suspension Check 2.
...
![CodyAlienJr performance relative to each team](CodyAlienJrGTS.jpg)
