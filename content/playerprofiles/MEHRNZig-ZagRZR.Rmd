...
this_res_long <- readRDS(paste0(rprojroot::find_rstudio_root_file(), "/playerprofiles/res_long.RDS")) %>%
  filter(Players=="MEHR@N", team=="Zig-Zag RZR")
...
MEHR@N is currently a player in Zig-Zag RZR.  
...
Their best score was 27543 in Breath In, Breath Out 2.

Their highest rank within the team was `r bestrank` `r best` 

Their scores relative to the rest of the team are shown in the figure and table below. In the figure, the red line shows the trajectory of MEHR@N's scores. The grey line shows the team median and the grey ribbon indicates the range from top five score to bottom five score.

![MEHR@N performance relative to each team](MEHRNZig-ZagRZR.jpg)
