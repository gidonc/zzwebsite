...
this_res_long <- readRDS(paste0(rprojroot::find_rstudio_root_file(), "/playerprofiles/res_long.RDS")) %>%
  filter(Players=="Special One", team=="GTS")
...
Special One is currently a player in GTS.  
...
Their best score was 33372 in Timesplitting 3.
...
![Special One performance relative to each team](SpecialOneGTS.jpg)
