...
this_res_long <- readRDS(paste0(rprojroot::find_rstudio_root_file(), "/playerprofiles/res_long.RDS")) %>%
  filter(Players=="Muskaan.Ali", team=="GTS")
...
Muskaan.Ali is currently a player in GTS.  
...
Their best score was 10480 in Spring Into Action 1.

Their highest rank within the team was `r bestrank` `r best` 

Their scores relative to the rest of the team are shown in the figure and table below. In the figure, the red line shows the trajectory of Muskaan.Ali's scores. The grey line shows the team median and the grey ribbon indicates the range from top five score to bottom five score.

![Muskaan.Ali performance relative to each team](MuskaanAliGTS.jpg)


### Muskaan.Ali's scores
