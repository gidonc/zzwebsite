...
this_res_long <- readRDS(paste0(rprojroot::find_rstudio_root_file(), "/playerprofiles/res_long.RDS")) %>%
  filter(Players=="Desbok", team=="GTS")
...
Desbok is currently a player in GTS.  
...
Their best score was 25815 in Timesplitting 3.
...
![Desbok performance relative to each team](DesbokGTS.jpg)
