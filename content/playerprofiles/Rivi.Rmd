...
Rivi is currently a player in GS.

Their best score has been 33723 in I Hate Fish 4.

Their highest rank within the team was `r bestrank` `r best` 

The red line in the graph below shows the trajectory of Rivi's scores. The grey line shows the team median and the grey ribbon indicates the range from top five score to bottom five score.

![Rivi performance relative to each team](Rivi.jpg)
