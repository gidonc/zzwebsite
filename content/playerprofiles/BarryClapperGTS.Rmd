...
this_res_long <- readRDS(paste0(rprojroot::find_rstudio_root_file(), "/playerprofiles/res_long.RDS")) %>%
  filter(Players=="Barry Clapper", team=="GTS")
...
Barry Clapper is currently a player in GTS.  
...
Their best score was 27638 in Breathe In, Breathe Out 1.
...
![Barry Clapper performance relative to each team](BarryClapperGTS.jpg)
