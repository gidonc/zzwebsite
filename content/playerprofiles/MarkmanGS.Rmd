...
this_res_long <- readRDS(paste0(rprojroot::find_rstudio_root_file(), "/playerprofiles/res_long.RDS")) %>%
  filter(Players=="Markman", team=="GS")
...
Markman is currently a player in GS.  
...
Their best score was 26977 in Bonus Bonanza 2.
...
![Markman performance relative to each team](MarkmanGS.jpg)
