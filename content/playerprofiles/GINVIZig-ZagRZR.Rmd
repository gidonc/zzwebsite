...
this_res_long <- readRDS(paste0(rprojroot::find_rstudio_root_file(), "/playerprofiles/res_long.RDS")) %>%
  filter(Players=="GINVI", team=="Zig-Zag RZR")
...
GINVI is currently a player in Zig-Zag RZR.  
...
Their best score was 32573 in Top Speed 3.
...
![GINVI performance relative to each team](GINVIZig-ZagRZR.jpg)
