...
this_res_long <- readRDS(paste0(rprojroot::find_rstudio_root_file(), "/playerprofiles/res_long.RDS")) %>%
  filter(Players=="B33FY WOLVES", team=="GT")
...
B33FY WOLVES is currently a player in GT.  
...
Their best score was 18699 in Sweaty Palms 1.

Their highest rank within the team was `r bestrank` `r best` 

Their scores relative to the rest of the team are shown in the figure and table below. In the figure, the red line shows the trajectory of B33FY WOLVES's scores. The grey line shows the team median and the grey ribbon indicates the range from top five score to bottom five score.

![B33FY WOLVES performance relative to each team](B33FYWOLVESGT.jpg)


### B33FY WOLVES's scores
