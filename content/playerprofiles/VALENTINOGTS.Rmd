...
this_res_long <- readRDS(paste0(rprojroot::find_rstudio_root_file(), "/playerprofiles/res_long.RDS")) %>%
  filter(Players=="VALENTINO", team=="GTS")
...
VALENTINO is currently a player in GTS.  
...
Their best score was 21516 in Nailbiter 1.
...
![VALENTINO performance relative to each team](VALENTINOGTS.jpg)
