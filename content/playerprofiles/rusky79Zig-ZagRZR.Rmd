...
this_res_long <- readRDS(paste0(rprojroot::find_rstudio_root_file(), "/playerprofiles/res_long.RDS")) %>%
  filter(Players=="rusky79", team=="Zig-Zag RZR")
...
Their best score was 36270 in Suspension Check 3.
...
![rusky79 performance relative to each team](rusky79Zig-ZagRZR.jpg)
