...
this_res_long <- readRDS(paste0(rprojroot::find_rstudio_root_file(), "/playerprofiles/res_long.RDS")) %>%
  filter(Players=="Dcurious13", team=="GTS")
...
Dcurious13 is currently a player in GTS.  
...
Their best score was 19444 in Bereft Of Benzine 3.
...
![Dcurious13 performance relative to each team](Dcurious13GTS.jpg)
