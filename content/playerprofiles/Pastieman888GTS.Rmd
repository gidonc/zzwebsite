...
this_res_long <- readRDS(paste0(rprojroot::find_rstudio_root_file(), "/playerprofiles/res_long.RDS")) %>%
  filter(Players=="Pastieman888", team=="GTS")
...
Pastieman888 is currently a player in GTS.  
...
Their best score was 11677 in Cresting The Hill 1.

Their highest rank within the team was `r bestrank` `r best` 

Their scores relative to the rest of the team are shown in the figure and table below. In the figure, the red line shows the trajectory of Pastieman888's scores. The grey line shows the team median and the grey ribbon indicates the range from top five score to bottom five score.

![Pastieman888 performance relative to each team](Pastieman888GTS.jpg)


### Pastieman888's scores
