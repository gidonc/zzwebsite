...
Dudd is currently a player in GS.  
...
Their best score was 31284 in Lug-Nut With Friends 4.

Their highest rank within the team was `r bestrank` `r best` 

Their scores relative to the rest of the team are shown in the figure and table below. In the figure, the red line shows the trajectory of Dudd's scores. The grey line shows the team median and the grey ribbon indicates the range from top five score to bottom five score.

![Dudd performance relative to each team](DuddGS.jpg)
